...
import { sqlInclusiveDateRange } from "../../common/utils/sql-calendar-date.util";
import {
...
export class ReportsService {
  ...
  private buildSaleSqlFilter(
    ...
    const parts: Prisma.Sql[] = [
      ...
      Prisma.sql`AND ${sqlInclusiveDateRange(
